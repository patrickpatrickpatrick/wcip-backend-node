...
var _a = process.env, SUPABASE_KEY = _a.SUPABASE_KEY, IGDB_SECRET = _a.IGDB_SECRET, IGDB_ID = _a.IGDB_ID;
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                return [4 /*yield*/, (0, utils_1.getIgdbToken)(IGDB_ID, IGDB_SECRET)];
            case 1:
...
app.post('/arcades', function (c) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, gameId, regionId, cityId, countryId, data;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0: return [4 /*yield*/, c.req.json()];
            case 1:
                _a = _b.sent(), gameId = _a.gameId, regionId = _a.regionId, cityId = _a.cityId, countryId = _a.countryId;
                return [4 /*yield*/, (0, supabase_1.getGameData)(gameId, { regionId: regionId, cityId: cityId, countryId: countryId })];
            case 2:
                data = _b.sent();
                if (data) {
...
app.post('/games', function (c) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                query = (_a.sent()).query;
                queryIgdb = "search \"".concat(query.replaceAll("\"", ""), "\"; fields name,first_release_date;");
                return [4 /*yield*/, (0, utils_1.gamesApiFetch)(IGDB_ID, accessToken, queryIgdb)];
            case 3:
                response = _a.sent();
